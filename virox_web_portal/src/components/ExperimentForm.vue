<template>
    <div class="card-body">
        ...
        <form id="general-input-form">
            <div class="form-inline form-group row ">
                <div class="form-group col-auto">
                    <label class="my-1 mr-2" for="inputLOTNO"><strong>LOT NO: </strong></label>
                    <input type="input" :value="record.LOT_NO" class="form-control" id="inputLOTNO">
                </div>
                <div class="form-group col-auto">
                    <label class="my-1 mr-2" for="inputProjectTitle"><strong>Project Title: </strong></label>
                    <input type="text" class="form-control" id="inputProjectTitle" :value="record.project_title">
                </div>
            </div>
            ...
            <div class="form-group form-inline row">
                <div class="form-group col-auto">
                    ...
                    <input type="text" :value="record.prepared_by" class="form-control" id="inputPrepBy">
                </div>
                <div class="form-group col-auto">
                    <label class="my-1 mr-2" for="inputQuantity"><strong>Quantity: </strong></label>
                    <input type="text" class="form-control" id="inputQuantity" :value="record.quantity">
                </div>
            </div>
            <button type="submit" @click="submit" class="btn btn-primary">Sign in</button>
        </form>
    </div>
